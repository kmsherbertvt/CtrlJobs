#= The idea here is to plot εvA, GvA, and xvA.

But xvA requires a separate plot for each job,
    like the "nodal" plots, while εvA and GvA can combine jobs.

TODO: Figure this out.

TODO: Figure out how to plot cold-start figs,
    which is also hard because their attributes don't mean quite the same thing.
(It may or may not be appropriate to consider diff(I) rather than I.)
