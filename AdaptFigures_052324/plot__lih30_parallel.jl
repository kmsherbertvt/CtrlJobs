...
include("lih30_surveys.jl"); surveys = lih30_surveys

prefix = "lih30_parallel"
...
plot!(plt, surveys.nodal)
plot!(plt, surveys.nodal_each)
plot!(plt, surveys.nodal_all)
