...
In THIS script, we'll try to get some hyperspace action by letting coupled qubits be a potentially more direct path. So for now couple one ancilla with all data qubits.
