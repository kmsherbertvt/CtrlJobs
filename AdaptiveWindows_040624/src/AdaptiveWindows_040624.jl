module AdaptiveWindows_040624
    ...
    import .Adaptations: makepool_bisection, makepool_random
    import .Adaptations: makepool_nodes, makepool_optimal, makepool_brute
    import .Adaptations: upHk_naive, upHk_slate, upHk_recycle
    import .Adaptations: select_one, select_oneperpulse, select_oneperwindow
    ...
    Adaptations.makepool_bisection(args...) = makepool_bisection(_!, args...)
    Adaptations.makepool_random(args...) = makepool_random(_!, args...)
    Adaptations.makepool_nodes(args...) = makepool_nodes(_!, args...)
    Adaptations.makepool_optimal(args...) = makepool_optimal(_!, args...)
    Adaptations.makepool_brute(args...) = makepool_brute(_!, args...)

    Adaptations.select_one(args...) = select_one(_!, args...)
    Adaptations.select_oneperpulse(args...) = select_oneperpulse(_!, args...)
    Adaptations.select_oneperwindow(args...) = select_oneperwindow(_!, args...)
...
end # module AdaptiveWindows_040624
